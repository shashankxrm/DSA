...
public class zigzagIterator {
    private final java.util.Iterator<Integer> it1; private final java.util.Iterator<Integer> it2;
    ...
    public zigzagIterator(java.util.List<Integer> v1, java.util.List<Integer> v2) {
        this.it1 = v1.iterator(); this.it2 = v2.iterator(); this.turn = true; // Start with the first iterator
    }
    public Integer next() {
        if (!hasNext()) { return null; // No more elements to return
        }
        if (turn && it1.hasNext()) {
